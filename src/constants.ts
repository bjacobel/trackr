...
export const TRACKR_ABSOLUTE_CATS = (process.env.NEXT_PUBLIC_TRACKD_ABSOLUTE || '').split(',');
export const HAS_ABSOLUTE_CATS = !!TRACKR_ABSOLUTE_CATS.length && !!TRACKR_ABSOLUTE_CATS[0].length;
